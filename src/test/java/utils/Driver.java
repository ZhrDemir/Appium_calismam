...
import java.util.concurrent.TimeUnit;
    public class Driver {
        ...
        static final String TELEFONADI="Pixel 3";
        ...
        public static AndroidDriver getAndroidDriver()  {
            ...
            if (appiumDriver == null) {
                ...
                caps.setCapability("appPackage","com.skypicker.main");//şu an Kiwi
                caps.setCapability("appActivity","com.kiwi.android.feature.splash.impl.ui.SplashActivity");//şu an Kiwi
